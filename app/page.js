...
const members = [
  {
    name: "林新恩",
    dept: "資訊管理學系四年級",
    role: "團隊接洽窗口／UI/UX 設計與品牌形象",
    desc:
      "負責 App 介面設計、品牌識別與對外接洽。在緊急情境下「一眼看懂、一手按到」是設計目標；也負責使用者測試的招募與訪談，把回饋帶回團隊。",
  },
  {
    name: "江宗諺",
    dept: "資訊管理學系四年級",
    role: "核心技術開發／AI 助理「阿巧」與人工覆核",
    desc:
      "負責 AI 問答助理「阿巧」、後端與開放資料整合。在 AI 管理制度中擔任技術負責人與人工覆核者：每月抽樣檢視 AI 對話品質、維護緊急關閉機制、參與事件應變演練。",
  },
  {
    name: "張書涵",
    dept: "資訊管理學系四年級",
    ...
    desc:
      "負責團隊整體方向、時程與資源。曾主導教育部青年發展署專案，從提案、預算到結案；目前推動校園示範、地方政府與企業合作，以及補助計畫的申請與執行。",
  },
  {
    name: "林威岑",
    dept: "資訊工程學系三年級",
    role: "系統架構與地圖功能開發／AI 管理與資料保護負責人",
    desc:
      "負責災害地圖、系統整合與資安。受過 ISO/IEC 42001 主導稽核員與 27701 稽核員訓練，擔任團隊的 AI 管理負責人與資料保護聯絡人：建立 AI 治理制度與文件、核准風險處置、負責隱私政策與個資法遵。",
  },
  {
    name: "柯達宏",
    dept: "機械工程學系二年級",
    role: "產品策略與使用者體驗優化",
    desc:
      "負責產品概念發想、功能優先順序與使用者體驗。曾於 iGEM 國際競賽榮獲金牌，擅長問題分析與系統性思考；也負責防災教育內容與工作坊教材的規劃。",
  },
];
